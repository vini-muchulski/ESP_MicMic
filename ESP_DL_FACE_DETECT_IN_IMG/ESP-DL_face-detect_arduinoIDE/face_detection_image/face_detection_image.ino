...
//HumanFaceDetectMSR01 s1(0.03F, 0.4F, 10, 0.2F);
//HumanFaceDetectMNP01 s2(0.3F, 0.2F, 5);

// Estágio 1 – rápido
HumanFaceDetectMSR01 s1(0.075F, 0.5F, 10, 0.2F);  // score, NMS, C, N

// Estágio 2 – refinamento
HumanFaceDetectMNP01 s2(0.5F, 0.3F, 5);        // score, NMS, N
